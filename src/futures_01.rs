...
//!
//! Futurify uses `futures 0.1` if you opt-in by using the `futures_01` feature and opting out of the default features.
//!
//! # Examples
//!
...
//!
//! ```rust,no_run
//! use actix_web_1::{web, App, Error, HttpServer, Responder};
//! use futures01::Future;
//! use std::time::Duration;
//!
//! fn index_async() -> impl Future<Item = impl Responder, Error = Error> {
//!    use std::future::Future;
//! futures01::future::ok("Hello world")
//! }
//!
...
//!        futures01::future::ok("Hello blocking world")
//!    })
//! }
//!
